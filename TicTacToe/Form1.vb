Public Class Form1
    ...
    Private Sub btn_next_Click(sender As Object, e As EventArgs) Handles btn_next.Click
        If (player1_name.Text = "" Or player1_name.Text = "player x's name") And (player2_name.Text = "" Or player2_name.Text = "player o's name") Then
            MsgBox("Enter the player's name.")
        ElseIf player1_name.Text = "" Or player1_name.Text = "player x's name" Then
            MsgBox("Enter Player X's name.")
        ElseIf player2_name.Text = "" Or player2_name.Text = "player o's name" Then
            MsgBox("Enter Player O's name.")
    ...
    Private Sub player2_name_KeyDown(sender As Object, e As KeyEventArgs) Handles player2_name.KeyDown, player1_name.KeyDown
